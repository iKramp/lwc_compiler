...
enum class symbol_tokens{BRACKET_L, BRACKET_R, SCOPE_BRACKET_L, SCOPE_BRACKET_R, COMMA, NUM_TYPES};
...
const std::string math_type_names  [9 ] = {"plus", "minus", "bsl", "bsr", "or", "xor", "and", "not"};
const std::string logic_type_names [7 ] = {"assign", "not_eq", "less_eq", "less", "more_eq", "more", "equal"};
const std::string symbol_type_names[5 ] = {"(", ")", "{", "}", ","};
